...
Подробные учебные правила вынесены в `docs/notes/MENTORING_GUIDE.md`, глобальный шаблон синхронизирован с коротким мостом, а установщик перестал создавать идентичный дубликат. Одноразовый сценарий переноса позднее удалён после завершения миграции рабочей области.
