...
Эти проекты намеренно пока не установлены как активные presets. При возобновлении работы создай для выбранного проекта самостоятельный Git-репозиторий в `~/codex-workspace/<project>`.
