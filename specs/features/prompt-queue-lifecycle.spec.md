...
| PQ-04 | Reusable/reference и обычный master с keep сохраняются; completed historical execution master снимает keep только через PQ-13 |
...
| PQ-13 | Completed historical execution master с overall DoD может пройти exact-item guard при durable canonical refs и обязательных PASS `orphan_audit`, `runtime_parity`, `regression`; partial master и reusable/reference сохраняются |
...
Новые unit/CLI/adapter-receipt tests реализуют PQ-01..10 и hierarchical eligibility PQ-12..13; current project structural test и реальная
