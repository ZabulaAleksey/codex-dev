...
- NEXT: implement and verify `DEV-SEP-E` diagnostics/retirement/integration, then automatically
  select the unique dependency-ready `DEV-SEP-F`. A checkpoint is not a stop condition;
...
- Status: `running`; Lifecycle: `implementation`; predecessor `DEV-SEP-D` verified at `907b3d5`.
