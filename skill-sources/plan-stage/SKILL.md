...
1. Прочитай инструкции проекта, current selector/record в `prompts/STAGES.md` и `specs/README.md`, если он существует.
...
8. Записывай или обновляй план только в соответствующем record `prompts/STAGES.md` и только по
