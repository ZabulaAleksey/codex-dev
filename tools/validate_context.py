...
REQUIRED = {
    ...
    "templates/dev-project/.codex/dev-project.toml",
    "templates/dev-project/.codex/bootstrap.ps1",
    "templates/dev-project/.codex/bootstrap.sh",
    ...
    "tools/test_master_execution.py",
